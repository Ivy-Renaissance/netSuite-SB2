    ...
    const post = (context) => {
        ...
        try {
            ...
            let itemSearch = search.create({
                ...
                columns: [
                    search.createColumn({ name: 'custbody_swc_platform_order_number' }),
            ...
            itemSearch.run().each(rec => {

                let orderNo = rec.getValue('custbody_swc_platform_order_number');
                let sku = rec.getValue({ name: 'displayname', join: 'item' });
