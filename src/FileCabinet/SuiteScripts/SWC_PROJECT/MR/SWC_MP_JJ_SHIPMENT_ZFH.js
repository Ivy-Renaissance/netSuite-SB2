 ...
 *@author ZJG
 *@name SWC_MP_JJ_SHIPMENT_ZFH.js
 *@description 自发货发货报告处理
 */
define(['../common/interface', '../common/moment', 'N/runtime', 'N/record', 'N/search', 'N/format', 'N/error'],
    function (interface, moment, runtime, record, search, format, error) {
        ...
        var shipment_record_type = 'customrecord_swc_jj_zfh_shipment'
        function getInputData() {
            var startTime = new Date().getTime();
            log.emergency('getInputData 开始', startTime);
            var acc = runtime.getCurrentScript().getParameter({ name: 'custscript_swc_jj_zs_store' });
            var orderid = runtime.getCurrentScript().getParameter({ name: 'custscript_swc_jj_zs_orderid' });
            var shipdate_start = runtime.getCurrentScript().getParameter({ name: 'custscript_swc_jj_zs_shipdate_start' });
            var shipdate_end = runtime.getCurrentScript().getParameter({ name: 'custscript_swc_jj_zs_shipdate_end' });
            var req_limit = runtime.getCurrentScript().getParameter({ name: 'custscript_swc_jj_zs_limit' });
            var memo = runtime.getCurrentScript().getParameter({ name: 'custscript_swc_jj_zs_memo' });
            ...
            var limit = 399;
            var filters = [
                { name: 'custrecord_swc_jj_zs_resolved', operator: 'is', values: false },
                // { name: 'custentity_swc_platform', join: 'custrecord_swc_jj_zs_store', operator: 'noneof', values: '9' }
                // { name: 'custrecord_swc_jj_zs_error', operator: 'contains', values: '订单转换成功，待下一次处理' },
            ]
            if (orderid) {
                filters.push({ name: 'custrecord_swc_jj_zs_source_order_no', operator: 'is', values: orderid })
            };
            if (acc) {
                filters.push({ name: 'custrecord_swc_jj_zs_store', operator: 'anyof', values: acc })
            };
            if (shipdate_end && shipdate_start) {
                filters.push({ name: 'custrecord_swc_jj_zs_delivery_date', operator: 'within', values: [shipdate_start, shipdate_end] })
            }
            if (shipdate_end && !shipdate_start) {
                filters.push({ name: 'custrecord_swc_jj_zs_delivery_date', operator: 'onorbefore', values: shipdate_end })
            }
            if (!shipdate_end && shipdate_start) {
                filters.push({ name: 'custrecord_swc_jj_zs_delivery_date', operator: 'onorafter', values: shipdate_start })
            }
            if (req_limit) {
                limit = req_limit;
            }
            if (memo) {
                filters.push({ name: 'custrecord_swc_jj_zs_error', operator: 'contains', values: memo })
            }
            ...
            search.create({
                ...
                filters: filters,
                columns: [
                    { name: 'custrecord_swc_jj_zs_retry', sort: search.Sort.ASC },
                    { name: 'custrecord_swc_jj_zs_delivery_date', sort: search.Sort.ASC },
                    { name: 'custrecord_swc_jj_zs_quantity' },
                    { name: 'custrecord_swc_jj_zs_msku' },
                    { name: 'custrecord_swc_jj_zs_source_order_no' },
                    { name: 'custrecord_swc_jj_zs_store' },
                    { name: 'custrecord_swc_jj_zs_order_type' },
                    { name: 'custrecord_swc_jj_zs_warehouse_id' },
                    { name: 'custrecord_swc_jj_zs_warehouse_name' },
                    { name: 'custrecord_swc_jj_zs_erp_order_line_no' },
                    { name: 'custrecord_swc_jj_zs_shippingamount' },
                    { name: 'custrecord_swc_jj_zs_others' },
                    { name: 'custrecord_swc_jj_zs_source_channel' },
                    { name: 'custrecord_swc_jj_zs_fo_order_no' },
                    { name: 'custrecord_swc_jj_zs_body' },
                ]
            }).run().each(function (rec) {
                orders.push({
                    fsd_id: rec.id,
                    fsd_retry: rec.getValue({ name: 'custrecord_swc_jj_zs_retry', sort: search.Sort.ASC }),
                    fsd_acc_id: rec.getValue('custrecord_swc_jj_zs_store'),
                    fsd_shipment_date: rec.getValue({ name: 'custrecord_swc_jj_zs_delivery_date', sort: search.Sort.ASC }),
                    fsd_quantity: rec.getValue('custrecord_swc_jj_zs_quantity'),
                    fsd_sku: interface.replaceToChinessChar(rec.getValue('custrecord_swc_jj_zs_msku')),
                    fsd_order_id: rec.getValue('custrecord_swc_jj_zs_source_order_no'),
                    fsd_order_type: rec.getValue('custrecord_swc_jj_zs_order_type'),
                    fsd_sp_warehouse_id: rec.getValue('custrecord_swc_jj_zs_warehouse_id'),
                    fsd_sp_warehouse_name: rec.getValue('custrecord_swc_jj_zs_warehouse_name'),
                    fsd_order_line_no: rec.getValue('custrecord_swc_jj_zs_erp_order_line_no'),
                    fsd_shippingamount: rec.getValue('custrecord_swc_jj_zs_shippingamount'),
                    fsd_others_fee: rec.getValue('custrecord_swc_jj_zs_others'),
                    fsd_source_channel: rec.getValue('custrecord_swc_jj_zs_source_channel'),
                    fsd_fo_order_no: rec.getValue('custrecord_swc_jj_zs_fo_order_no'),
                    fsd_body: JSON.parse(rec.getValue('custrecord_swc_jj_zs_body')),
                })
                return --limit > 0
            })
        ...
        function reduce(context) {
            ...
            var fsd_sp_warehouse_name = obj.fsd_sp_warehouse_name;
            var fsd_order_line_no = obj.fsd_order_line_no;
            var fsd_shippingamount = obj.fsd_shippingamount;
            var fsd_others_fee = obj.fsd_others_fee;
            var fsd_source_channel = obj.fsd_source_channel;
            var fsd_fo_order_no = obj.fsd_fo_order_no;
            var fsd_body = obj.fsd_body;
            var fsd_tracking_no = fsd_body.foOrderLogisticsInfoVO.trackingNo;
            ...
            try {
                if (Number(fsd_quantity) == 0) {
                    record.submitFields({
                        type: shipment_record_type,
                        id: fsd_id,
                        values: {
                            custrecord_swc_jj_zs_error: '本次发货数量为0',
                            custrecord_swc_jj_zs_resolved: true,
                        },
                        options: {
                ...
                if (!acc_info.plan_metrics) {
                    throw '店铺 备货维度 未维护';
                }
                if (!acc_info.pj_plan_metrics) {
                    throw '店铺 配件备货维度 未维护';
                }


                log.audit('fsd_order_type', fsd_order_type);
                if (fsd_order_type == 'STANDARD') {
                    so_obj = interface.SearchSalesOrder(fsd_acc_id, fsd_order_id, true, fsd_source_channel);
                    log.audit('so_obj', so_obj);
                    so_id = so_obj.so_id;
                    if (so_id) {

                        var location_attribute = '';
                        //TODO:测试环境ID 81
                        //TODO:生产环境ID 20
                        ...
                        var location_info = interface.GetLocationInfo(fsd_sp_warehouse_id, '', acc_info.plan_metrics, '', location_attribute);
                        log.audit('正常地点 location_info', location_info);
                        ...
                        if (so_obj.ord_status == 'fullyBilled') {
                            record.submitFields({
                                ...
                                id: fsd_id,
                                values: {
                                    custrecord_swc_jj_zs_location: location_info.id,
                                    custrecord_swc_jj_zs_error: '没发货已开票',
                                    custrecord_swc_jj_zs_resolved: true,
                                },
                                options: {
                                    ignoreMandatoryFields: true
                        ...
                        for (var index = 0; index < so_items.length; index++) {
                            if (so_items[index].so_item_seller_sku == fsd_sku && so_items[index].so_item_platform_line_id == fsd_order_line_no) {
                                ...
                                items_info.push({
                                    ...
                                    so_item_platform_line_id: so_items[index].so_item_platform_line_id,
                                    so_item_line_no: so_items[index].so_item_line_no,
                                    so_item_item_cplb: so_items[index].so_item_item_cplb,
                                })
                                flag = true
                                break
                            }
                        ...
                        if (!flag) {
                            for (var index = 0; index < so_items.length; index++) {
                                if (so_items[index].so_item_seller_sku == fsd_sku) {
                                    if (so_items[index].so_item_quantityshiprecv > 0) {
                                        quantityshiprecv = true;
                                        if (!so_items[index].so_item_location) {
                                            delete_if = true;
                            ...
                            if (!oii_flag) {
                                var reason = '自发货单匹配不到so货品明细行。so明细信息：' + JSON.stringify(so_items) + ',发货报告信息：seller sku=' + fsd_sku
                                log.error('reason', reason);
                                record.submitFields({
                                    type: shipment_record_type,
                                    id: fsd_id,
                                    values: {
                                        // custrecord_swc_jj_zs_location: so_ship_location,
                                        custrecord_swc_jj_zs_error: reason,
                                        custrecord_swc_jj_zs_retry: Number(fsd_retry) + 1
                                    },
                                    options: {
                                        ignoreMandatoryFields: true
                                    }
                        ...
                        if (delete_if) {
                            ...
                            record.submitFields({
                                ...
                                id: fsd_id,
                                values: {
                                    custrecord_swc_jj_zs_error: '重新执行',
                                    custrecord_swc_jj_zs_retry: Number(fsd_retry) + 1
                                },
                                options: {
                                    ignoreMandatoryFields: true
                        ...
                        //TODO:测试环境ID：7
                        //TODO:生产环境ID：7
                        if (items_info[0].so_item_item_cplb == '7') {
                            var pj_location_info = interface.GetLocationInfo(fsd_sp_warehouse_id, '', acc_info.pj_plan_metrics, '', location_attribute);
                            log.audit('配件地点 pj_location_info', pj_location_info);
                        ...
                        search.create({
                            type: 'invoice',
                            filters: [
                                { name: 'custbody_swc_jj_zfh_shipment', operator: 'anyof', values: fsd_id },
                        ...
                        if (inv_id.length == 1 && fulfill_id.length == 1) {
                            ...
                            record.submitFields({
                                ...
                                values: {
                                    custrecord_swc_jj_zs_location: so_ship_location,
                                    custrecord_swc_jj_zs_error: '已存在此报告的发票',
                                    custrecord_swc_jj_zs_resolved: true,
                                },
                                options: {
                                    ignoreMandatoryFields: true
                            ...
                            record.submitFields({
                                ...
                                values: {
                                    custrecord_swc_jj_zs_location: so_ship_location,
                                    custrecord_swc_jj_zs_error: '发货有问题，停止发货，需要人工检查问题',
                                },
                                options: {
                                    ignoreMandatoryFields: true
                                }
                        ...
                        log.audit('判断子公司', {
                            so_subsidiary: so_obj.subsidiary,
                            lc_subsidiary: real_location_info.subsidiary,
                        });

                        if (so_obj.subsidiary == real_location_info.subsidiary) {
                            SOAddlocation(so_id, so_ship_location, items_info);
                            so_itemfulfillment_id = SoToItemFulfillment(fsd_id, so_obj, fsd_order_id, fsd_shipment_date, fsd_sku, fsd_order_line_no, fsd_quantity, acc_info, so_ship_location, oii_flag, fsd_shippingamount, fsd_others_fee, real_location_info, {}, fsd_fo_order_no, fsd_tracking_no);
                            log.audit('so_itemfulfillment_id', so_itemfulfillment_id);
                            if (so_itemfulfillment_id) {
                                so_invoice_id = SoToInvoice(fsd_id, so_obj, fsd_shipment_date, so_itemfulfillment_id, fsd_sku, fsd_order_line_no, fsd_quantity, oii_flag, fsd_shippingamount, fsd_others_fee);
                                ...
                                if (so_invoice_id) {
                                    record.submitFields({
                                        ...
                                        values: {
                                            custrecord_swc_jj_zs_location: so_ship_location,
                                            custrecord_swc_jj_zs_resolved: true,
                                            custrecord_swc_jj_zs_error: '',
                                            custrecord_swc_jj_zs_relation_if: so_itemfulfillment_id,
                                            custrecord_swc_jj_zs_relation_iv: so_invoice_id,
                                            custrecord_swc_jj_zs_relation_so: so_obj.so_id,
                                        },
                                        options: {
                                            ignoreMandatoryFields: true
                                        }
                        ...
                        so_obj = interface.SearchSalesOrder(fsd_acc_id, fsd_order_id, false, fsd_source_channel, true);
                        if (so_obj.so_id) {
                            let if_id = '', inv_id = '';
                            search.create({
                                type: 'itemfulfillment',
                                filters: [
                                    { name: 'createdfrom', operator: 'is', values: so_obj.so_id },
                                    { name: 'custcol_swc_msku', operator: 'is', values: fsd_sku },
                                ],
                            }).run().each(function (rec) {
                                if_id = rec.id;
                            });
                            if (if_id) {
                                search.create({
                                    type: 'invoice',
                                    filters: [
                                        { name: 'custbody_swc_related_item_fulfillment', operator: 'anyof', values: if_id },
                                    ],
                                    columns: [
                                        { name: 'internalId' }
                                    ]
                            ...
                            record.submitFields({
                                ...
                                values: {
                                    custrecord_swc_jj_zs_resolved: true,
                                    custrecord_swc_jj_zs_error: '',
                                    custrecord_swc_jj_zs_relation_if: if_id,
                                    custrecord_swc_jj_zs_relation_iv: inv_id,
                                    custrecord_swc_jj_zs_relation_so: so_obj.so_id,
                                },
                                options: {
                                    ignoreMandatoryFields: true
                ...
                } else if (fsd_order_type == 'PRE_ORDER') {
                    throw '预售订单,暂无处理逻辑';
                } else if (fsd_order_type == 'SUPPLEMENTARY') {
                    throw '补录订单,暂无处理逻辑';
                } else if (fsd_order_type == 'REISSUE') {
                    //售后订单
                    so_obj = interface.SearchSalesOrder(fsd_acc_id, fsd_order_id, true, 'AfterSales');
                    log.audit('so_obj', so_obj);
                    so_id = so_obj.so_id;
                    if (so_id) {
                ...
                // }
                // }
                log.audit('real_location_info', real_location_info);
                if (real_location_info) {
                    log.audit('set ', '1');
                    record.submitFields({
                        type: shipment_record_type,
                        id: fsd_id,
                        values: {
                            ...
                            custrecord_swc_jj_zs_location: real_location_info.id,
                            custrecord_swc_jj_zs_error: e,
                            custrecord_swc_jj_zs_retry: Number(fsd_retry) + 1
                        },
                        options: {
                            ignoreMandatoryFields: true
        ...
        function SoToItemFulfillment(fsd_id, so_obj, fsd_order_id, fsd_shipment_date, fsd_sku, fsd_order_line_no, fsd_quantity, acc_info, so_ship_location, oii_flag, fsd_shippingamount, fsd_others_fee, real_location_info, to_po_info, fsd_fo_order_no, fsd_tracking_no) {
            log.debug('SoToItemFulfillment', {
                ...
                to_po_info: to_po_info,
            });
            var so_id = so_obj.so_id;
            var location = so_ship_location;
            var acc_timezone = acc_info.store_time_zone;
            log.audit('location', location);
            var t_item_id = '', t_item_type = '', o_item_type = '';
            try {
                ...
                f.setValue({ fieldId: 'custbody_swc_jj_zfh_shipment', value: fsd_id }); // 关联发货报告
                if (to_po_info.to_id) {
                    f.setValue({ fieldId: 'custbody_swc_transorder_id', value: to_po_info.to_id }); //关联转移单
                }
                if (to_po_info.po_id) {
                    f.setValue({ fieldId: 'custbody_swc_correlation_nb_po', value: to_po_info.po_id }); //关联内部交易PO
                }
                ...
                for (var i = 0; i < lineCount; i++) {
                    ...
                    // var f_item_cplb = f.getSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_item_cplb', line: i })  //货品产品类别
                    // if (f_item_cplb == '7') {
                    //     //TODO:测试环境ID 7
                    //     //TODO:生产环境ID
                    //     f.setSublistValue({ sublistId: 'item', fieldId: 'location', value: pj_location_info.id, line: i });
                    // }
                    ...
                    if (f_item_type == 'Kit') {
                        ...
                        if (f_seller_sku == fsd_sku && oii_flag ? true : platform_line_id == fsd_order_line_no) {
                            o_item_type = f_item_type;
                            t_item_type = f_item_type;
                            t_item_id = f_item_id;
                            log.debug('Kit', {
                                f_item_id: f_item_id,
                        ...
                        // f.setSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_others_price_', value: fsd_others_fee, line: i });
                        // f.setSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_shipping_price_', value: fsd_shippingamount, line: i });
                        f.setSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_lastmile_po1', value: fsd_fo_order_no, line: i });
                        f.setSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_lastmile_track1', value: fsd_tracking_no, line: i });
                        ...
                        if (f_seller_sku == fsd_sku && oii_flag ? true : platform_line_id == fsd_order_line_no) {
                            if (Number(n_set_qty) == 0) {
                                ...
                                f.setSublistValue({ sublistId: 'item', fieldId: 'itemreceive', value: true, line: i });
                                n_set_qty = interface.accSub(n_set_qty, fsd_quantity);
                            }
                        } else {
                            f.setSublistValue({ sublistId: 'item', fieldId: 'itemreceive', value: false, line: i });
                        }
                ...
                //         type: 'vendorbill',
                //         filters: [
                //             { name: 'createdfrom', operator: 'is', values: to_po_info.po_id },
                //             { name: 'mainline', operator: 'is', values: true },
                //         ],
                //     }).run().each(function (b) {
                //         if (b.id) {
                //             record.delete({ type: 'vendorbill', id: b.id });
                //         }
                //         return true;
                //     });
                // }
                ...
                // if (to_po_info.ir_id) {
                //     record.delete({ type: 'itemreceipt', id: to_po_info.ir_id });
                // }
                // if (to_po_info.inv_id) {
                //     record.delete({ type: 'invoice', id: to_po_info.inv_id });
                // }
                // if (to_po_info.if_id) {
                //     record.delete({ type: 'itemfulfillment', id: to_po_info.if_id });
                // }
                // if (to_po_info.to_id) {
                //     record.delete({ type: 'transferorder', id: to_po_info.to_id });
                // }
                // log.audit('o_item_type', o_item_type);
                // log.audit('t_item_type', t_item_type);
                // log.audit('t_item_id', t_item_id);

                // if (o_item_type == 'Kit') {
                //     throw '套件自动公司间交易暂不处理';
                // }
                if (code == '5015' || code == '5016' || code == '5017') {
                    let tp_info = TransferInventory(fsd_id, so_obj, t_item_id, fsd_shipment_date, fsd_quantity, acc_info, real_location_info);
                    log.audit('tp_info', tp_info);
                    return SoToItemFulfillment(fsd_id, so_obj, fsd_order_id, fsd_shipment_date, fsd_sku, fsd_order_line_no, fsd_quantity, acc_info, so_ship_location, oii_flag, fsd_shippingamount, fsd_others_fee, real_location_info, tp_info);
                } else {
                    throw error.create({
                        name: code,
                        message: e,
        ...
        //原则一，优先考虑同主体下库存数量最多的仓库，条件，1、排除备货维度=HD-US    2、仓库属性=[海外仓，店铺虚拟仓]，生成转移单
        //原则二，当同主体仓库库存不足，则调拨不同主体库存数量最多的仓库，条件， 仓库属性=海外仓，店铺虚拟仓，生成公司间交易
        function TransferInventory(fsd_id, so_obj, item_id, fsd_shipment_date, fsd_quantity, acc_info, real_location_info) {
            try {
                log.audit('TransferInventory', {
                    fsd_id: fsd_id,
                    item_id: item_id,
                    fsd_shipment_date: fsd_shipment_date,
                    fsd_quantity: fsd_quantity,
                    acc_info: acc_info,
                    real_location_info: real_location_info,
                });
                var result = {};
                var ti_invennumber = [];
                ...
                var filters1 = [
                    { name: 'internalid', operator: 'anyof', values: item_id },
                    { name: 'locationquantityavailable', operator: 'greaterthan', values: ['0'] },
                    { name: 'custrecord_swc_location_attribute', join: 'inventorylocation', operator: 'anyof', values: ['6', '12'] },
                    { name: 'custrecord_swc_jj_warehouse_id', join: 'inventorylocation', operator: 'is', values: real_location_info.warehouse_id },
                    { name: 'subsidiary', join: 'inventorylocation', operator: 'anyof', values: real_location_info.subsidiary },
                    { name: 'inventorylocation', operator: 'noneof', values: real_location_info.id },
                ]
                if (runtime.accountId == '11297254_SB1') {
                    filters1.push({ name: 'custrecord_swc_location_store', join: 'inventorylocation', operator: 'noneof', values: ['2579'] });
                } else {
                    filters1.push({ name: 'custrecord_swc_location_store', join: 'inventorylocation', operator: 'noneof', values: ['155'] });
                }
                ...
                search.create({
                    ...
                    columns: [
                        ...
                        { name: 'locationquantityavailable', sort: 'DESC' },
                    ]
                }).run().each(function (rec) {
                    location_info = {
                        id: rec.getValue(rec.columns[0]),
                        qty: rec.getValue(rec.columns[1]),
                    }
                });
                log.audit('location_info1', location_info);

                if (Number(location_info.qty) >= Number(fsd_quantity)) {
                    //生成转移单to、if、ir
                    var to = record.create({ type: 'transferorder', isDynamic: true });
                    to.setValue({ fieldId: 'subsidiary', value: real_location_info.subsidiary });
                    to.setValue({ fieldId: 'location', value: location_info.id });
                    to.setValue({ fieldId: 'transferlocation', value: real_location_info.id });
                    to.setValue({ fieldId: 'orderstatus', value: "B" });
                    to.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                    to.setValue({ fieldId: 'useitemcostastransfercost', value: true })
                    to.setValue({ fieldId: 'custbody_swc_jj_zfh_shipment', value: fsd_id }); // 关联发货报告

                    to.selectNewLine({ sublistId: 'item' });
                    to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'item', value: item_id });
                    to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity });
                    if (islotitem || isserialitem) {
                        IsDynamicInventoryDetails(to, fsd_quantity, location_info.id, 'to', acc_info.store_time_zone, assetaccount, ti_invennumber);
                    } else {
                        SearchInventory(to, item_id, fsd_quantity, location_info.id, acc_info.store_time_zone, assetaccount);
                    }
                    to.commitLine({ sublistId: 'item' });
                    var to_id = to.save({ ignoreMandatoryFields: true });
                    log.audit('to_id', to_id);

                    var f = record.transform({ fromType: record.Type.TRANSFER_ORDER, toType: record.Type.ITEM_FULFILLMENT, fromId: Number(to_id), isDynamic: true, });
                    f.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                    f.setValue({ fieldId: 'shipstatus', value: 'C' });
                    var if_id = f.save({ ignoreMandatoryFields: true });
                    log.debug('if_id', if_id)

                    var ir = record.transform({ fromType: record.Type.TRANSFER_ORDER, toType: record.Type.ITEM_RECEIPT, fromId: Number(to_id), isDynamic: true, });
                    ir.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                    var ir_id = ir.save({ ignoreMandatoryFields: true });
                    log.debug('ir_id', ir_id)
                    ...
                    var filters2 = [
                        ...
                        { name: 'custrecord_swc_location_attribute', join: 'inventorylocation', operator: 'anyof', values: ['6', '12'] },
                        { name: 'custrecord_swc_jj_warehouse_id', join: 'inventorylocation', operator: 'is', values: real_location_info.warehouse_id },
                        { name: 'subsidiary', join: 'inventorylocation', operator: 'noneof', values: real_location_info.subsidiary },
                        { name: 'inventorylocation', operator: 'noneof', values: real_location_info.id },
                    ]
                    ...
                    search.create({
                        ...
                        location_info = {
                            id: rec.getValue(rec.columns[0]),
                            qty: rec.getValue(rec.columns[1]),
                            cost: rec.getValue(rec.columns[2]) || 0,
                        }
                    });
                    log.audit('location_info2', location_info);
                    if (Number(location_info.qty) > Number(fsd_quantity)) {
                        if (Number(location_info.cost) == 0) {
                            throw '公司间交易成本为0';
                        }
                        //生成公司间交易po、so、if、inv、ir、bill
                        var lc_info = interface.GetLocationInfo('', location_info.id);
                        var lc_sub_info = search.lookupFields({ type: 'subsidiary', id: lc_info.subsidiary, columns: ['representingvendor'] });
                        var representingvendor = lc_sub_info['representingvendor'][0].value;
                        var real_sub_info = search.lookupFields({ type: 'subsidiary', id: real_location_info.subsidiary, columns: ['representingcustomer'] });
                        var representingcustomer = real_sub_info['representingcustomer'][0].value;
                        log.audit('lc_info', lc_info);
                        log.audit('lc_sub_info', lc_sub_info);
                        log.audit('real_location_info', real_location_info);
                        log.audit('real_sub_info', real_sub_info);

                        var po = record.create({ type: 'purchaseorder', isDynamic: true });
                        po.setValue({ fieldId: 'entity', value: representingvendor });
                        po.setValue({ fieldId: 'subsidiary', value: real_location_info.subsidiary });
                        po.setValue({ fieldId: 'location', value: real_location_info.id });
                        po.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                        po.setValue({ fieldId: 'currency', value: so_obj.currency });
                        po.setValue({ fieldId: 'custbody_swc_jj_zfh_shipment', value: fsd_id }); // 关联发货报告
                        po.setValue({ fieldId: 'approvalstatus', value: 2 });   //已核准状态
                        po.setValue({ fieldId: 'orderstatus', value: 'B' });
                        po.selectNewLine({ sublistId: 'item' });
                        po.setCurrentSublistValue({ sublistId: 'item', fieldId: 'item', value: item_id });
                        po.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity });
                        po.setCurrentSublistValue({ sublistId: 'item', fieldId: 'rate', value: location_info.cost });
                        po.commitLine({ sublistId: 'item' });
                        var po_id = po.save({ ignoreMandatoryFields: true });
                        log.audit('po_id', po_id);

                        var so = record.create({ type: 'salesorder', isDynamic: true, defaultValues: { autogeneratedfromicq: 'T' } });
                        so.setValue({ fieldId: 'entity', value: representingcustomer });
                        so.setValue({ fieldId: 'subsidiary', value: lc_info.subsidiary });
                        so.setValue({ fieldId: 'location', value: lc_info.id });
                        so.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                        so.setValue({ fieldId: 'currency', value: so_obj.currency });
                        so.setValue({ fieldId: 'intercotransaction', value: po_id });
                        so.setValue({ fieldId: 'custbody_swc_jj_zfh_shipment', value: fsd_id }); // 关联发货报告
                        so.setValue({ fieldId: 'orderstatus', value: 'B' });
                        so.selectNewLine({ sublistId: 'item' });
                        so.setCurrentSublistValue({ sublistId: 'item', fieldId: 'item', value: item_id });
                        so.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity });
                        so.setCurrentSublistValue({ sublistId: 'item', fieldId: 'rate', value: location_info.cost });
                        so.commitLine({ sublistId: 'item' });
                        var so_id = so.save({ ignoreMandatoryFields: true });
                        log.audit('so_id', so_id);

                        var if_rec = record.transform({ fromType: 'salesorder', toType: 'itemfulfillment', fromId: so_id, isDynamic: true });
                        if_rec.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                        if_rec.setValue({ fieldId: 'shipstatus', value: 'C' });
                        var if_line = if_rec.getLineCount({ sublistId: 'item' });
                        for (let i = 0; i < if_line; i++) {
                            if_rec.selectLine({ sublistId: 'item', line: i });
                            if_rec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'itemreceive', value: true });
                            if_rec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'location', value: lc_info.id });
                            if_rec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity });
                            if (islotitem || isserialitem) {
                                IsDynamicInventoryDetails(if_rec, fsd_quantity, location_info.id, 'so', acc_info.store_time_zone, assetaccount, ti_invennumber);
                            } else {
                                SearchInventory(if_rec, item_id, fsd_quantity, location_info.id, acc_info.store_time_zone, assetaccount);
                            }
                            if_rec.commitLine({ sublistId: 'item' });
                        }
                        var if_id = if_rec.save({ ignoreMandatoryFields: true });
                        log.audit('if_id', if_id);
                        log.audit('ti_invennumber', ti_invennumber);


                        var inv_rec = record.transform({ fromType: 'salesorder', toType: 'invoice', fromId: so_id, isDynamic: true });
                        inv_rec.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                        var approval_invoice = interface.GetInvoceApproval();
                        if (approval_invoice) {
                            inv_rec.setValue({ fieldId: 'approvalstatus', value: 2 });
                        }
                        inv_rec.setValue({ fieldId: 'custbody_swc_related_item_fulfillment', value: if_id });
                        var inv_id = inv_rec.save({ ignoreMandatoryFields: true });
                        log.audit('inv_id', inv_id);


                        var ir_rec = record.transform({ fromType: 'purchaseorder', toType: 'itemreceipt', fromId: po_id, isDynamic: true });
                        ir_rec.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                        var ir_line = ir_rec.getLineCount({ sublistId: 'item' });
                        for (let i = 0; i < ir_line; i++) {
                            ir_rec.selectLine({ sublistId: 'item', line: i });
                            var ir_item_id = ir_rec.getCurrentSublistValue({ sublistId: 'item', fieldId: 'item' });

                            ir_rec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'itemreceive', value: true });
                            ir_rec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'location', value: real_location_info.id });
                            ir_rec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity });
                            if (islotitem || isserialitem) {
                                let inventorydetail = ir_rec.getCurrentSublistSubrecord({ sublistId: 'item', fieldId: 'inventorydetail' });
                                for (let j = 0; j < ti_invennumber.length; j++) {
                                    if (ti_invennumber[j].itemid == ir_item_id) {
                                        inventorydetail.selectNewLine({ sublistId: 'inventoryassignment' });
                                        inventorydetail.setCurrentSublistText({ sublistId: 'inventoryassignment', fieldId: 'receiptinventorynumber', text: ti_invennumber[j].inventorynumber });
                                        inventorydetail.setCurrentSublistValue({ sublistId: 'inventoryassignment', fieldId: 'quantity', value: ti_invennumber[j].quantity });
                        ...
                        var ir_id = ir_rec.save({ ignoreMandatoryFields: true });
                        log.audit('ir_id', ir_id);

                        // var bill_rec = record.transform({ fromType: 'purchaseorder', toType: 'vendorbill', fromId: po_id, isDynamic: true });
                        // bill_rec.setValue({ fieldId: 'trandate', value: fsd_shipment_date });
                        // bill_rec.setValue({ fieldId: 'approvalstatus', value: 2 });
                        // var bill_id = bill_rec.save({ ignoreMandatoryFields: true });
                        // log.audit('bill_id', bill_id);
                        ...
                        throw '自动调拨、公司间交易库存不足。itemid:' + item_id + ',积加仓库id:' + real_location_info.warehouse_id;
                    }
                }

            } catch (error) {
                log.error('TransferInventory error', error);
                // if (bill_id) {
                //     record.delete({ type: 'vendorbill', id: bill_id });
                // }
                if (po_id) {
                    search.create({
                        type: 'vendorbill',
                ...
                if (to_id) {
                    record.delete({ type: 'transferorder', id: to_id });
                }
        ...
        function SoToInvoice(fsd_id, so_obj, fsd_shipment_date, f_id, fsd_sku, fsd_order_line_no, fsd_quantity, oii_flag, fsd_shippingamount, fsd_others_fee) {
            try {
                fsd_shipment_date = format.parse({ value: fsd_shipment_date, type: 'date' });
                ...
                inv.setValue({ fieldId: 'custbody_swc_jj_zfh_shipment', value: fsd_id });
                // 强制限制发票的行等于发货的行
                ...
                for (var i = seted; i < len; i++) {
                    ...
                    if ((msku == fsd_sku && oii_flag ? true : fsd_order_line_no == platform_line_id) && fsd_quantity <= qty && ck) {
                        seted = i + 1
                        ck = false
                        inv.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity });
                        // inv.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_others_price_', value: fsd_others_fee });
                        // inv.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_shipping_price_', value: fsd_shippingamount });
        ...
        function SSoToItemFulfillment(icto, fsd_id, so_obj, so_id, fsd_order_id, fsd_shipment_date, fsd_shipment_date_text, sku_obj, fsd_sku, fsd_quantity, fsd_merchant_order_item_id, so_account, acc_info, global_config, so_ship_location, to_bin_invennumber, to_invennumber, oii_flag) {
            ...
            try {
                ...
                for (var i = 0; i < lineCount; i++) {
                    ...
                    if (bin && location_bin && item_bin) {
                        if (f_item_type == 'Kit') {
                            kit_quantityremaining = f.getSublistValue({ sublistId: 'item', fieldId: 'quantityremaining', line: i });
                            if (f_seller_sku == fsd_sku && oii_flag ? true : f_order_item_id == fsd_merchant_order_item_id) { //行上sellersku和order item id跟发货报告上相同 
                                kit_line_no = f.getSublistValue({ sublistId: 'item', fieldId: 'custcol_swc_line_no', line: i });
                                f.setSublistValue({ sublistId: 'item', fieldId: 'quantity', value: fsd_quantity, line: i });
        ...
        function SSoToInvoice(icto, fsd_id, so_id, fsd_shipment_date, fsd_shipment_date_text, f_id, acc_info, sku_obj, fsd_sku, fsd_quantity, fsd_merchant_order_item_id, oii_flag) {
            try {
                fsd_shipment_date = format.parse({ value: fsd_shipment_date, type: 'date' });
                ...
                for (var i = seted; i < len; i++) {
                    ...
                    if ((msku == fsd_sku && oii_flag ? true : order_item_id == fsd_merchant_order_item_id) && fsd_quantity <= qty && ck) {
        ...
        function IsDynamicInventoryDetails(f, quantity, location, type, acc_timezone, assetaccount, ti_invennumber) {
            try {
        ...
        function DeleteInfo(so_id) {
            ...
            search.create({
                ...
                columns: [
                    { name: "custbody_swc_jj_zfh_shipment" }
                ]
            }).run().each(function (rec) {
                if (rec.getValue('custbody_swc_jj_zfh_shipment')) {
                    record.submitFields({
                        type: shipment_record_type,
                        id: rec.getValue('custbody_swc_jj_zfh_shipment'),
                        values: {
                            custrecord_swc_jj_zs_resolved: false
                        },
                        options: {
                            enableSourcing: false,
                            ignoreMandatoryFields: true,
