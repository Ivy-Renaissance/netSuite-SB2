    ...
    function fieldChanged(context) {
        try {
            ...
            if (field_id == 'custrecord_swc_premium_unit_price') {
                ...
                now_rec.setCurrentSublistValue({ sublistId: sublist_id, fieldId: 'custrecord_swc_premium_excluding_tax', value: excluding_tax_amt });
                ...
                var excluding_tax_amt = unit_price / (1 + Number(tax_rate));
                now_rec.setCurrentSublistValue({ sublistId: sublist_id, fieldId: 'custrecord_swc_good_excluding_tax', value: excluding_tax_amt });
                ...
                now_rec.setCurrentSublistValue({ sublistId: sublist_id, fieldId: 'custrecord_swc_good_excluding_tax', value: good_excluding_tax_amt });
                ...
                var excluding_tax_amt = unit_price / (1 + Number(tax_rate));
                now_rec.setCurrentSublistValue({ sublistId: sublist_id, fieldId: 'custrecord_swc_premium_excluding_tax_usd', value: excluding_tax_amt });
                ...
                var excluding_tax_amt = unit_price / (1 + Number(tax_rate));
                now_rec.setCurrentSublistValue({ sublistId: sublist_id, fieldId: 'custrecord_swc_good_excluding_tax_usd', value: excluding_tax_amt });
                ...
                var good_excluding_tax_amt = good_unit_price / (1 + Number(tax_rate));
                now_rec.setCurrentSublistValue({ sublistId: sublist_id, fieldId: 'custrecord_swc_good_excluding_tax_usd', value: good_excluding_tax_amt });
            }
        } catch (e) {
            log.debug('e', e);
        }
